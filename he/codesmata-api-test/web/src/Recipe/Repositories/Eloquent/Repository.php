...
namespace HelloFresh\Recipe\Repositories\Eloquent;

use HelloFresh\Recipe\Repositories\Contracts\RepositoryInterface;
use HelloFresh\Recipe\Repositories\Exceptions\RepositoryException;
...
abstract class Repository implements RepositoryInterface
{
     ...
     * @return mixed
     */
    public function insertBulk($tableName, array $bulkData)
    {
     ...
     * @return mixed
     */
    public function deleteWhereIn($tableName, array $keys, $whereInKey = 'id')
    {
